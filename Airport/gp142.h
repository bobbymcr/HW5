...
** August,   1995  v2.02
** October,  1995  v2.10
** RCS $Id: gp142.h,v 1.9 1998/12/29 18:16:36 boren Exp $
*/
...
/* verify that system defines are appropriate */
  ...
  #error In GP142.H, you must #define either MACINTOSH or WINDOWS or X11R6 (but not both).
#endif
...
extern int FAR GP142_open(EMPTY);   /* Initialize the GP142 library;  */
...
GP142_textXY(                   /* draw a string of text in the graphics window */
...
GP142_textP(                    /* draw a string of text in the graphics window */
    int color,                  /* color */
...
// Shuichi was here.
// This works for C, but not C++ very well, so I'm going to change it to something 
// more cleaner. See GP142Display.cpp for more details.
#ifndef __cplusplus
/*
